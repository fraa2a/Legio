...
- PR #36, `feat/ui-upgrade`, is still open. Do not modify, merge, rebase, use it as a base, or work on its branch. Phase 08 frontend work remains out of scope.
- PR #34 delivered Linux runner discovery and basic launch. A real Proton game process, lifecycle session, and stop were later observed on 2026-09-26; 07A is complete.
...
- Never touch PR #36 or `feat/ui-upgrade`. Do not modify, merge, rebase, use it as a base, or work on its branch.
